 ...
 */
movequeue * enqueue(mvqueue queue, move cmd);
 ...
 */
movestack * push(mvstack stack, move cmd);
 ...
 * needed.
 */
move * head(mvqueue queue, int nb);
 ...
 *
 * @param queue movequeue pointer to the queue/stack data structure.
 */
